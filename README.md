...
This is a sample template for dynamo-item-updater - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name dynamo-item-updater \
...
aws cloudformation describe-stacks \
    --stack-name dynamo-item-updater --query 'Stacks[].Outputs'
```
